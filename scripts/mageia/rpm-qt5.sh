#!/bin/bash
# Mageia: sudo urpmi --no-recommends rpmdevtools rpm-sign autoconf automake qt5-devel desktop-file-utils aspell-fr enchant2-aspell
...
if [ true ]; then
	rm awf-$qt.spec
	wget https://raw.githubusercontent.com/luigifab/awf-extended/refs/tags/v$version/scripts/mageia/awf-$qt.spec
