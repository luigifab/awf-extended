#!/bin/bash
# openSUSE: sudo zypper install rpmdevtools rpm-build autoconf automake libqt5-qtbase-devel desktop-file-utils aspell-fr
...
if [ true ]; then
	rm awf-$qt.spec
	wget https://raw.githubusercontent.com/luigifab/awf-extended/refs/tags/v$version/scripts/opensuse/awf-$qt.spec
