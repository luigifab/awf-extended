...
Function ComponentsPageShow
	SearchPath $0 "libgtk-win32-2.0-0.dll"
	StrCmp $0 "" notfound
	...
	notfound:
		MessageBox MB_OK|MB_ICONEXCLAMATION "GTK :ENGINEVERSION: not found"
		Goto done
	archmismatch:
		MessageBox MB_OK|MB_ICONEXCLAMATION "GTK :ENGINEVERSION: found with wrong architecture ($4)$\r$\n$0"
		Goto done
	badversion:
		MessageBox MB_OK|MB_ICONEXCLAMATION "GTK :ENGINEVERSION: found with wrong version ($1, $4)$\r$\n$0"
		Goto done
	goodversion:
		MessageBox MB_OK|MB_ICONINFORMATION "GTK :ENGINEVERSION: found with right version ($1, $4)$\r$\n$0"
	done:
FunctionEnd
